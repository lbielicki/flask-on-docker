...
class Local:
    ...
    def __init__(
            self, context_var: ContextVar[dict[str, t.Any]] | None = None) -> None:
    ...
    def __call__(self, name: str, *, unbound_message: str |
...
class _ProxyLookup:
    ...
    def __get__(self, instance: LocalProxy,
                owner: type | None = None) -> t.Any:
        if instance is None:
